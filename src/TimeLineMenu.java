...
public class TimeLineMenu
{
    ...
    String menuitems[][] = { {"Open","Save","SaveAs","Quit"},{"Add","Delete","EditTitle"},{"Enlarge","Shrink","TextSizeIncrease","TextSizeDecrease","Reload","Refresh"},{"Options"},{"Help","AboutTimeLine"}
    };
    ...
    int mi_num[][] = { {nFileOpen,nFileSave,nFileSaveAs,nFileQuit},{nEditAdd,nEditDelete,nEditEditTitle},{nViewEnlarge,nViewShrink,nViewTextSizeIncrease,nViewTextSizeDecrease,nViewReload,nViewRefresh},{nToolsOptions},{nHelpHelp,nHelpAboutTimeLine}
    };    
...
// 			    mi.setEnabled (false);
				...
				// mi.setShortcut(new MenuShortcut(KeyEvent.VK_Q|KeyEvent.CTRL_MASK));
		    }
	    }
